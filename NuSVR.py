...
def NuSVRRegressor(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="NuSVRRegressor", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
...
def NuSVRRegressorGS(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="NuSVRRegressorGS", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
