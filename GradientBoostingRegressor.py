...
def GradientBoosting(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="GradientBoosting", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
...
def GradientBoostingGS(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="GradientBoostingGS", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
