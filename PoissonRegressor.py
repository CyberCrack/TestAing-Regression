...
def PoissonReg(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="PoissonReg", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
...
def PoissonRegGS(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="PoissonRegGS", reg=[reg1, reg2], metrics=metrics, val_metrics=val_metrics)
