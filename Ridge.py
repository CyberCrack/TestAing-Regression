...
def RidgeRegressor(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="RidgeRegressor", reg=reg, metrics=metrics, val_metrics=val_metrics)
...
def RidgeRegressorGS(X_train, X_test, y_train, y_test):
	...
	logSave(nameOfModel="RidgeRegressorGS", reg=reg, metrics=metrics, val_metrics=val_metrics)
